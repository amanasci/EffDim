#!/usr/bin/env python3
"""CLI: order-stratified local geometry (d1, q2) audit."""
...
from geometry.physics_order_stratified_geometry.pipeline import (  # noqa: E402
    OrderStratConfig,
    run,
)
...
def main(argv: list[str] | None = None) -> None:
    ...
    p.add_argument(
        "--output-dir",
        default="outputs/geometry/physics_order_stratified_geometry",
    )

...
- [ ] **DATA-01**: A reader can load exactly one config of `UniverseTBD/pu-embeddings`
...
- [ ] **DATA-03**: The `_hsc` and `_legacysurvey` arrays are guaranteed row-aligned after
...
- [ ] **DATA-05**: The notebook states its own Python floor (3.11) and installs its
...
- [ ] **ISO-05**: A reader can re-run any notebook and get identical results from the cache,
